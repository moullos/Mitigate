...
Machine Interrogation To Identify Gaps & Techniques for Execution");
        ...
        public static void EnumStart(Enumeration Enum) 
        {
            PrintEnumStart(Enum.MitigationDescription);
            PrintRelevantTechniques(Enum.Techniques);

        }

        public static void PrintRelevantTechniques(string[] Techniques)
        {
            Console.ForegroundColor = ConsoleColor.DarkGray;
            Console.WriteLine("    Relevant Techniques: "+ String.Join(",", Techniques));
            Console.ResetColor();
        }

        public static void PrintEnumStart(string title)
        {
            Console.WriteLine();
            Console.Write("[");
        ...
        public static void PrintResultSymbol(ResultType result)
        {
            ...
            else if (result == ResultType.False)
            {
                Console.ForegroundColor = ConsoleColor.DarkRed;
                Console.Write("".PadRight(4, ' '));
                Console.Write("X ");
            ...
            else if (result == ResultType.TestFailed)
            {
                Console.ForegroundColor = ConsoleColor.DarkGray;
                Console.Write("".PadRight(4, ' '));
                Console.ForegroundColor = ConsoleColor.Red;
            ...
            else if (result == ResultType.Partial)
            {
                Console.ForegroundColor = ConsoleColor.DarkGray;
                Console.Write("".PadRight(4, ' '));
                Console.ForegroundColor = ConsoleColor.Yellow;
                Console.Write("Partially");
                Console.ResetColor();
            }
            else if (result == ResultType.CannotBeMeasured)
            {
                Console.Write("".PadRight(4, ' '));
                Console.ResetColor();
            }
            else if (result == ResultType.TestNotImplemented)
            {
                Console.Write("".PadRight(4, ' '));
                Console.ResetColor();
            }
        ...
        */
        public static void PrintDACL(List<Helper.ACE> DACL)
        {
            foreach (var ace in DACL)
            {
                var sid = new System.Security.Principal.SecurityIdentifier(ace.Trustee);
                Console.WriteLine($"Trustee: {Helper.SidToAccountName(sid)}");
